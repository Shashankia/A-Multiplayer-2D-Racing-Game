🎮 **RacerX** is a top-down 2D racing game developed using **Python** and the **Pygame** library. The project simulates realistic car movement, track boundaries, and race logic — built entirely from scratch.
